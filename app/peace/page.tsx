import PeaceRuntimeLoader from "./peace-runtime-loader";

export default function PeacePage() {
  return (
    <main className="peace-root">
      <a href="/" className="peace-back">← Back</a>
      <div className="container">
        <canvas id="canvas"></canvas>
        <div className="clean-btn">clean the screen</div>
      </div>

      <div id="peace-suggestion" className="peace-suggestion">
        <p>Click to add flowers</p>
        <button id="peace-suggestion-ok" type="button">OK</button>
      </div>

      <script type="x-shader/x-fragment" id="fragmentShader" dangerouslySetInnerHTML={{ __html: `
...
` }} />
      ...
      <script type="x-shader/x-vertex" id="vertexShader" dangerouslySetInnerHTML={{ __html: `
varying vec2 vUv;
void main() {
    vUv = uv;
